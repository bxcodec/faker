...
type Coupon struct {
	...
	ChinaFirstName string   `json:"china_first_name" faker:"chinese_first_name"`
	ChinaLsstName  string   `json:"china_last_name" faker:"chinese_last_name"`
	ChinaName      string   `json:"china_name" faker:"chinese_name"`
